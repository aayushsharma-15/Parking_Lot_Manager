               ...
               cout<<endl;
                ...
                vehicle.setDetails(license_plate,owner_name) ;
                 ...
                 if (parking_lot.is_space_available() ){
                    ...
                    if (spot_number != -1) {
                      cout<<endl;
                        cout << "PARKING SPOT ALLOTTED!"<<endl<<endl;
            ...
            cin>>spot_number;
                ...
                if(exit_temp){
                    ...
                    cout <<"Owner: " << vehicle_temp.getOwnerName() <<endl;
                     ...
                     if(total_fee==1000){
                       cout <<"Total fee: "<<"Rs." << total_fee <<RED_TEXT<<"(penalty)"<<RESET_COLOR<<endl<<endl;
                     }
                     else{
                        cout <<"Total fee: "<<"Rs." << total_fee <<endl<<endl;
                     }
                    ...
                    cout<<endl;
                     ...
                     cout<< "spot number is " <<GREEN_TEXT<< spot_number <<RESET_COLOR<<endl<<endl;
